...
public class PrometheusMetricResource {
  public static final Set<String> METRICS =
      Sets.newHashSet(NORMAL_CALL, ERROR_CALL, DELAY_CALL, Constants.LIST, STATUS, Constants.PROCESS, LIST_RT, STATUS_RT, PROCESS_RT,LIST_ERRORS, STATUS_ERRORS, PROCESS_ERRORS);
